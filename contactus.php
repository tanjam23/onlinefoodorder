      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="contactus.php">Kontaktiraj nas!</a></li>
          </ul>
...
?>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="customerlogin.php"><span class="glyphicon glyphicon"></span> Dobro dosli! <?php echo $_SESSION['login_user1']; ?> </a></li>
...
?>
    ...
    <div class="heading">
     <strong>Zelis nesto nam reci? <span class="edit"> Te Cafe' </span>?</strong>
     <br>
    Evo nacina da to uradis
    </div>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Kontakt forma</h3>

          <div class="form-group">
            <input type="text" class="form-control" id="name" name="name" placeholder="Ime" required autofocus="">
          </div>
          ...
          <div class="form-group">
            <input type="Number" class="form-control" id="mobile" name="mobile" placeholder="Broj telefona" required>
          </div>
          ...
          <div class="form-group">
           <textarea class="form-control" type="textarea" id="message" name="message" placeholder="Poruka" maxlength="140" rows="7"></textarea>
           <span class="help-block"><p id="characterLeft" class="help-block">Max karaktera: 140 </p></span>
          </div> 
          <input type="submit" type="button" id="submit" name="Posalji" />  
        </form>
