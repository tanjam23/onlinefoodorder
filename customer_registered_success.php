      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="customerlogin.php"><span class="glyphicon glyphicon"></span> Registruj se </a></li>
            <li><a href="customerlogin.php"><span class="glyphicon glyphicon"></span> Prijava </a></li>
          </ul>
        </div>
...
<div class="container">
	<div class="jumbotron" style="text-align: center;">
		<h2> <?php echo "Dobro dosao $fullname!" ?> </h2>
		<h1>Nalog uspesno kreiran!</h1>
		<p>Loguj se sad <a href="customerlogin.php">OVDE</a></p>
	</div>
</div>
