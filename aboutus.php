      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="aboutus.php">O nama</a></li>
...
?>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#"><span class="glyphicon glyphicon"></span> Dobro dosli! <?php echo $_SESSION['login_user1']; ?> </a></li>
...
?>
    ...
    <div class="wide">
       ...
       <h3 style="color: red">Ostani kod kuce i naruci!</h3>
        <h3 style="color: green"><br>
        Zasto bi se izlagala/o riziku i izlazio napolje kada cemo mi obaviti to za tebe!</h3>
        <br>
